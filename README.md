...
### 🔗 Active Scrum Sprint Tracker: [Q3 VIP Customer Retention Campaign](https://github.com/users/VI5HU17/projects/1)
...
* **Core Logic Location:** View the script logic in the [`analytics_engine/`](./analytics_engine/) directory.
* **Data Source:** Raw mockup data is stored directly in [`analytics_engine/data/transactions.csv`](./analytics_engine/data/transactions.csv).
...
* **Project Charter:** Outlines strict project boundaries, business cases, KPIs, success metrics, and stakeholder ownership. View the [`project_charter.md`](./pm_playbook/project_charter.md).
* **Agile Backlog & Sprints:** Translates high-level business goals into engineering, data, and creative user stories complete with explicit **Acceptance Criteria**. View the [`agile_backlog.md`](./pm_playbook/agile_backlog.md).
* **Risk Management:** Preemptively tracks system blockages, data sync integration failures, and creative scope creep using an operational mitigation matrix. View the [`risk_management.md`](./pm_playbook/risk_management.md).
...
1. Clone the repository:
   ```bash
   git clone https://github.com/VI5HU17/marops-analytics-pm-engine.git
